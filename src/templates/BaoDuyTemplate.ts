      ...
      <div class="seller-box">
        <div class="seller-info">
          <div class="info-row">
            ...
            <span class="seller-name" style="margin-left:6px;">${escapeHtml(invoice.nbten || 'CÔNG TY TNHH THƯƠNG MẠI TRANG SỨC BẢO DUY')}</span>
          </div>
          <div class="info-row">
            <span class="info-label">Mã số thuế (Tax code):</span>
            <span style="font-weight:bold;margin-left:6px;letter-spacing:1px;">${escapeHtml(renderSpacedTaxCode(invoice.nbmst || '0318657735'))}</span>
          </div>
          <div class="info-row">
            <span class="info-label">Địa chỉ (Address):</span>
            <span style="margin-left:6px;">${escapeHtml(invoice.nbdchi || '324/2 Ấp Chánh 1, Xã Hóc Môn, Thành phố Hồ Chí Minh, Việt Nam')}</span>
          </div>
          <div class="info-row">
      ...
      <div class="signature-grid">
        ...
        <div class="sig-col">
          ...
          <div class="sig-box-softdreams">
            ...
            <div><strong>Ký bởi:</strong> CÔNG TY TNHH THƯƠNG MẠI TRANG SỨC BẢO DUY</div>
