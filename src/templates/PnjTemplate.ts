  ...
  <div class="invoice-outer">
    ...
    <div class="footer-lookup">
      ...
      <div class="footer-lookup-flex">
        <div>Tra cứu thông tin hóa đơn điện tử tại: <a href="${escapeHtml(directLookupUrl)}" target="_blank" rel="noopener noreferrer" style="color:#0284c7;text-decoration:underline;">${escapeHtml(pUrl)}</a></div>
